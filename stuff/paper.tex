...
\begin{figure}[H]
    \centering
    \includegraphics{triangle_reflect}
...
\begin{figure}[H]
    \centering
    \includegraphics{triangle_expand}
...
\begin{figure}[H]
    \centering
    \includegraphics{triangle_contract}
...
\begin{figure}[H]
    \centering
    \includegraphics{triangle_compress}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Coordinate_descent}
