...
\begin{figure}[H] \centering \begin{tikzpicture} \begin{axis} \addplot3[surf] {x*y^2}; \addplot3[->] coordinates {(-1.5,-0.5,54) (-2.5,-3.5,-70)};  \addplot3[only marks] coordinates {(-2,-2,-8)}; \end{axis} \end{tikzpicture} \caption[Gradientenvektor Beispiel] {Hier zu sehen ist -$\vec{\nabla}f(-2,-2)$ der Funktion $f(x,y)=x*y^2$} \end{figure}
...
$c = 0.01$ und $\beta = 0.9$ häufig gute Ergebnisse. (QUELLE: \href{https://www.unibw.de/lrt1/gerdts/lehre/lpnlp/lp-nlp.pdf}{https://www.unibw.de/lrt1/gerdts/lehre/lpnlp/lp-nlp.pdf}) 
